"""Competitor intel — the system finally sees something other than itself.
  ...
  python -m carshorts.intel.competitors                    # pull + benchmark + report
  python -m carshorts.intel.competitors --add @motoroctane # extend the watch list
  python -m carshorts.intel.competitors --limit 40         # deeper history per channel
