"""The system's own judgment layer — bounded decisions without a chat session.
  ...
  python -m carshorts.brain triage        # classify unresolved QA/VQA failures
  python -m carshorts.brain vet <file>    # second opinion on an asset
  python -m carshorts.brain strategy      # weekly strategy note from all data
