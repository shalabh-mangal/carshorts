"""First-frame engineering — on Shorts, frame 1 IS the thumbnail.
  ...
  python -m carshorts.firstframe out/creta_selfrender.mp4      # audit ours
  python -m carshorts.firstframe --benchmark                   # rival baseline
  python -m carshorts.firstframe out/x.mp4 --vision --subject "Hyundai Creta"
...
def build_baseline(limit: int = 20, max_duration: int = 180) -> dict:
    ...
    from .competitors import _recent_videos, _resolve, load_watchlist
