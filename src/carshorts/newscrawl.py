"""News crawler — fresh, source-bound car news for specs_extras.
  ...
  python -m carshorts.newscrawl "Mahindra Thar"            # preview what it found
  python -m carshorts.newscrawl "Tata Punch" --write       # merge into specs_extras/
  python -m carshorts.newscrawl "Hyundai Creta" --days 30
