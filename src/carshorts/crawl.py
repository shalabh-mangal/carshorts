"""Crawl real car specs into JSON files the harness can replay.
  ...
  python -m carshorts.crawl "Tata Nexon" "Mahindra Thar" "Maruti Suzuki Fronx"
  python -m carshorts.crawl --out specs --min-specs 2 "Hyundai Creta"
...
from .adapters.specsource import WikipediaSpecSource
