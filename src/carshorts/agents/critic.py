...
def run(slug: str, provider: str | None = None) -> dict:
    ...
    system = (
        ...
        "1. HOOK stopping-power in the first 2 seconds (a hero number / curiosity gap wins).\n"
        ...
        "exterior line).\n"
        "3. Tightness — the proven winner is ~90 words / ~30s; longer loses reach.\n"
        "4. Overlay + voice alignment and engagement levers (like-at-peak, a binary poll comment).\n"
        "5. Any TASTE or accuracy risk.\n"
        "Be specific and honest, but also name what genuinely works. Ground every point in the "
        "proven learnings below.\n\nPROVEN LEARNINGS:\n" + load_learnings_guidance(12)
    )
    user = (
