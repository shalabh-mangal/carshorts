...
def run(slug: str, provider: str | None = None) -> dict:
    ...
    system = (
        ...
        "1. HOOK stopping-power in the first 2 seconds — the #1 lever. A QUESTION / "
        "curiosity-gap hook (ideally with a hero number) is the proven winner: across 12 "
        "published videos question hooks massively out-viewed news/price-hike ones (Sonet "
        "1557, Swift 478, MG 321 vs Brezza 40, Thar 118, Creta 244). REWARD a curiosity-gap "
        "or provocative-question opener; FLAG a flat news / price-hike / plain-statement hook "
        "as a retention risk and suggest the question reframe. FRAME 1 must be MOTION or a "
        "bold hero shot: if the first beat's opening clip looks static/interior/badge, flag it "
        "(a boring frame 1 costs the swipe before a word is heard).\n"
